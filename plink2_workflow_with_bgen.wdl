...
task run_interaction {
	...
	String plink2_parameter_string = read_string(plink2_parameter_file)
		...
		/plink2 \
			${"--bgen " + genofile_bgen + " ref-first"} \
			${"--sample " + genofile_sample} \
			--allow-extra-chr \
			--pheno-name ${outcome} \
...
workflow run_plink2 {
	...
	Array[File] genofiles_bgen
	Array[File] genofiles_sample
	File phenofile
	String sample_id_header
	String outcome
	Boolean binary_outcome
